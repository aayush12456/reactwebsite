...
import './Header.css'
import './t20 worldcup 2007.css'
import { Link } from 'react-router-dom'
export const T20worldcup = () => {
    return (
        <div>
          <iframe width="560" height="315" src="https://www.youtube.com/embed/O8lzehSorR0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen className='v1'></iframe>
          <div className='nav1'>
