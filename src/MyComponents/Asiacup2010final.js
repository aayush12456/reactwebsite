...
import './Header.css'
import './Asiacup2010.css'
import { Link } from 'react-router-dom'
export const Asiacup2010final = () => {
    return (
        <div>
            <iframe  src="https://www.youtube.com/embed/nxRfiFTR7Is" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" className="y1" allowfullscreen></iframe>
            <div className='nav1'>
